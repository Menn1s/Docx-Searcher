...
def process_directory(directory_path, keywords, case_insensitive, extend_regex):
...
if __name__ == "__main__":
    ...
    parser.add_argument("-H", "--header", action="store_true", help="Search for matching headers only")
    ...
    process_directory(args.directory_path, args.keywords, args.case_insensitive, args.extend_regex)
